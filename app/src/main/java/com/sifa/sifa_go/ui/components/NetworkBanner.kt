...
import com.sifa.sifa_go.ui.theme.WarningOrange
...
fun NetworkBanner(
    ...
    val noNetwork = networkStatus !is NetworkStatus.Available
    val noGps = gpsStatus !is GpsStatus.Available

    AnimatedVisibility(
        visible = noNetwork || noGps,
