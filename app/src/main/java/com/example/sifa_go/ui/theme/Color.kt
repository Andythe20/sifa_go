...
// Paleta Institucional "SIFA GO" (Modo Claro)
val PrimaryBlue = Color(0xFF1F477B)     // Azul institucional para botones principales, header y textos clave
val SecondaryBlue = Color(0xFF4A74AA)   // Un azul un poco más claro para elementos secundarios
...
val TextSecondary = Color(0xFF49454F)   // Gris oscuro para subtítulos o etiquetas